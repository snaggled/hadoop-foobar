...
I've added to code for this example to "github":sdfsdfsdf but the core of it is that we're going to need a couple of things to get started. The first ones a dataset. Yahoo Finance can provide what we need through the following webservices call:
